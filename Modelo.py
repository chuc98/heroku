...
def IngresarIDelante(busqueda,_nombrearchivo):
    try:
        ...
        if _nombrearchivo and busqueda:            
            ...
            #sqlDropProcedure="DROP PROCEDURE IF EXISTS actualizarPost;"
            # #cursor.execute(sqlDropProcedure)
            sqlCreateSP="UPDATE "+ _TABLA +" SET IDelante ='"+ _nombrearchivo +"',  UStatus = UStatus + 25 WHERE UEmail = '"+usuario+"'"
            print("paso 5")
            cursor.execute(sqlCreateSP)
            print("paso 6")
            #cursor.execute("INSERT INTO "+_TABLA+"(Usuario, Evento) VALUES (%s, %s)", (_usuario, _evento))            #cursor.callproc('actualizarPost',(_postulante))            data = cursor.fetchall()
...
def IngresarIDetras(busqueda,_nombrearchivo):
    try:
        ...
        if _nombrearchivo and busqueda:            
            ...
            #sqlDropProcedure="DROP PROCEDURE IF EXISTS actualizarPost;"
            # #cursor.execute(sqlDropProcedure)
            sqlCreateSP="UPDATE "+ _TABLA +" SET IDetras ='"+ _nombrearchivo +"',  UStatus = UStatus + 25 WHERE UEmail = '"+usuario+"'"
            print("paso 5")
            cursor.execute(sqlCreateSP)
            print("paso 6")
            #cursor.execute("INSERT INTO "+_TABLA+"(Usuario, Evento) VALUES (%s, %s)", (_usuario, _evento))            #cursor.callproc('actualizarPost',(_postulante))            data = cursor.fetchall()
...
def IngresarComprobante(busqueda,_nombrearchivo):
    try:
        ...
        if _nombrearchivo and busqueda:            
            ...
            #sqlDropProcedure="DROP PROCEDURE IF EXISTS actualizarPost;"
            # #cursor.execute(sqlDropProcedure)
            sqlCreateSP="UPDATE "+ _TABLA +" SET Comprobante ='"+ _nombrearchivo +"',  UStatus = UStatus + 25 WHERE UEmail = '"+usuario+"'"
            print("paso 5")
            cursor.execute(sqlCreateSP)
            print("paso 6")
            #cursor.execute("INSERT INTO "+_TABLA+"(Usuario, Evento) VALUES (%s, %s)", (_usuario, _evento))            #cursor.callproc('actualizarPost',(_postulante))            data = cursor.fetchall()
...
def IngresarSelfie(busqueda,_nombrearchivo):
    try:
        #   _usuario = request.args.get('Usuario')
        #   _evento = request.args.get('Evento')
        usuario=busqueda
        if _nombrearchivo and busqueda:            
            ...
            #sqlDropProcedure="DROP PROCEDURE IF EXISTS actualizarPost;"
            # #cursor.execute(sqlDropProcedure)
            sqlCreateSP="UPDATE "+ _TABLA +" SET Selfie ='"+ _nombrearchivo +"',  UStatus = UStatus + 25 WHERE UEmail = '"+usuario+"'"
            print("paso 5")
            cursor.execute(sqlCreateSP)
            print("paso 6")
            #cursor.execute("INSERT INTO "+_TABLA+"(Usuario, Evento) VALUES (%s, %s)", (_usuario, _evento))            #cursor.callproc('actualizarPost',(_postulante))            data = cursor.fetchall()
...
def ImagenATextoINE(busqueda,_urline):
    ...
    try:
        ...
        if busqueda:            
            ...
            #sqlDropProcedure="DROP PROCEDURE IF EXISTS actualizarPost;"
            # #cursor.execute(sqlDropProcedure)
            sqlCreateSP="UPDATE "+ _TABLA +" SET UName ='"+ Nombre +"',  URFC = '"+ curp +"',  UDate = '"+ fecha2 +"',  UAdd = '"+ domicilio2 +"'  WHERE UEmail = '"+usuario+"'"
            print("paso 5")
            cursor.execute(sqlCreateSP)
            print("paso 6")
            #cursor.execute("INSERT INTO "+_TABLA+"(Usuario, Evento) VALUES (%s, %s)", (_usuario, _evento))            #cursor.callproc('actualizarPost',(_postulante))            data = cursor.fetchall()
...
def ImagenATextoINEAtras(busqueda,_urline):
    ...
    try:
        ...
        if busqueda:            
            ...
            #sqlDropProcedure="DROP PROCEDURE IF EXISTS actualizarPost;"
            # #cursor.execute(sqlDropProcedure)
            sqlCreateSP="UPDATE "+ _TABLA +" SET Idatras ='"+ idatras +"'  WHERE UEmail = '"+usuario+"'"
            print("paso 5")
            cursor.execute(sqlCreateSP)
            print("paso 6")
            #cursor.execute("INSERT INTO "+_TABLA+"(Usuario, Evento) VALUES (%s, %s)", (_usuario, _evento))            #cursor.callproc('actualizarPost',(_postulante))            data = cursor.fetchall()
...
def ImagenATextoDomicilio(busqueda,_urline):
    _url=open(_urline,"rb")
    _resultado=_client.batch_read_file_in_stream(_url, raw=True)
    _url.close()
    ol=_resultado.headers["Operation-Location"]
    ...
    #print(contador)
    regex = (r"ROBERTO DE JESUS GARCIA VARELA\n"
	r"([a-zA-Z0-9]+.+)\n"
	r"([a-zA-Z0-9]+.+)"
	)

    direccion = re.findall(regex, contador, re.MULTILINE)
    #matches = re.findall(regex, contador, re.MULTILINE)
    direccion=direccion[0][0]+","+direccion[0][1]
    print(direccion)
    ...
    try:
        ...
        if busqueda:            
            ...
            #sqlDropProcedure="DROP PROCEDURE IF EXISTS actualizarPost;"
            # #cursor.execute(sqlDropProcedure)
            sqlCreateSP="UPDATE "+ _TABLA +" SET UAdd ='"+ direccion +"'  WHERE UEmail = '"+usuario+"'"
            print("paso 5")
            cursor.execute(sqlCreateSP)
            print("paso 6")
            #cursor.execute("INSERT INTO "+_TABLA+"(Usuario, Evento) VALUES (%s, %s)", (_usuario, _evento))            #cursor.callproc('actualizarPost',(_postulante))            data = cursor.fetchall()
